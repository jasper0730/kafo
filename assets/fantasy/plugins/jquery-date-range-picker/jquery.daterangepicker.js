    ...
    $.fn.dateRangePicker = function(opt)
    {
        ...
        function init_datepicker()
        {
            ...
            box.find('.next').click(function()
            {
                ...
                if (!opt.singleDate && !isMonth2 && compare_month(month, opt.month2) >= 0)
                    return;
            ...
            box.find('.prev').click(function()
            {
                ...
                if (isMonth2 && compare_month(month, opt.month1) <= 0)
                    return;
                showMonth(month, isMonth2 ? 'month2' : 'month1');
                showGap();
            });
        ...
        function createDom()
        {
            ...
            html += '</div>\
					...
					<div class="default-top">default</div>\\n\
                                        <input type="button" class="btn clear-btn ' + getHideClass() + '" value="' + lang('clear') + '" />\
