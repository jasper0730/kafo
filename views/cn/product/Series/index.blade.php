...
<!--產品BANNER-->
  <div class="container top-bar">
    <div class="bread-crumbs">
      ...
      <a href="{{ ItemMaker::url('Product') }}">高锋产品</a><span></span>
...
<!---->
  ...
  <nav class="container product-d-menu">
    <ul>
      <li class="hvr-rectangle-out"><a href="{{ ItemMaker::url('Product/Series').'/'.$Series->id  }}#detail01" class="fontM">特点</a></li>
      <li class="hvr-rectangle-out"><a href="{{ ItemMaker::url('Product/Series').'/'.$Series->id  }}#detail02" class="fontM">规格</a></li>
      @if($Series->accessory_file)
        <li class="hvr-rectangle-out"><a target="_blank" href="{{  $Series->accessory_file }}" class="fontM">选配表</a></li>
      @endif
  ...
  <section id="detail01" class="features">
    ...
    <div  class="features02">
      <h2 class="detail-txt-title">核心技术</h2>
    ...
    <div id="detail02" class="features03">
      <div class="container">
        <h2 class="detail-txt-title">规格</h2>
    ...
    <div class="contact-us-block">
      ...
      <p class="contact-us-p">如果您想要了解更多关于我们的产品，欢迎随时与我们联系。</p>
      <a class="contact-us-button hvr-rectangle-out" href="{{ ItemMaker::url('contact') }}">联络我们</a>
    </div>
