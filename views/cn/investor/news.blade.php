...
<div class="wrapperINV">
    ...
    <div class="bannerINV">
        <div class="xsBGshow" data-small="upload/newsBg-s.jpg" data-large="upload/newsBg.jpg" style="background:url('upload/newsBg.jpg') no-repeat center center; background-size:cover"><!--PC圖尺寸1440x530--><!--手機尺寸 640x400-->
...
<div class="middleMenu-Fin">
    <ul>
        <li><a href="{{ItemMaker::url('Investor/news#middlemenu')}}">重大訊息</a></li>
        <li><a href="{{ItemMaker::url('Investor/activity#middlemenu')}}">活動紀錄</a></li>
    </ul>
</div>
...
{{--非共用js區塊--}}
@section('script')
<script type="text/javascript" src="assets/js/admin/investor/investorNews.js"></script>
@stop
