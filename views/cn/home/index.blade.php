...
<div class="wrapper page-home">
  ...
  <ul class="left-menu">
    <li class="current"><a href="#home01">首页</a></li>
    <li><a href="{{ ItemMaker::url('/') }}#home02">最新产品</a></li>
    <li><a href="{{ ItemMaker::url('/') }}#home03">最新消息</a></li>
    <li><a href="{{ ItemMaker::url('/') }}#home04">关于高锋</a></li>
  </ul>
...
<!--****-->
  ...
  <a href="#home02"><h2 class="title">热门产品</h2></a>
          ...
          <div class="banner-slick">
            ...
            <div class="product-indexTit">
              <div class="inner">
                ...
                <a href="{{ ItemMaker::url('Product/Series').'/'.$value->id }}" class="fontM hvr-rectangle-out btn-gray">阅读更多</a>
              </div>
            </div>
...
<!--****-->
  ...
  <a href="#home03"><h2 class="title">最新消息</h2></a>
    ...
    <div class="home-news-main">
      ...
      <a href="{{ ItemMaker::url('news') }}" class="hvr-rectangle-out btn-more">更多新闻</a>
    </div>
  </section>
  <section id="home04" class="home-about">
  <a href="#home04"><h2 class="title">关于高锋</h2></a>
    <div class="home-about-main">
      ...
      <div class="home-about-menu">
        ...
        <!--<span class="fontM">选择高锋相关单元</span>-->
      </div>
    </div>
  </section>
  <!--****-->
