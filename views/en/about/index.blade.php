...
<div class="wrapper page-product">
  ...
  <!-- 中間選單 -->
  <ul class="navbar">
    <li><a href="{{ ItemMaker::url('About') }}#about02">COMPANY</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about03">HISTORICAL</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about04">CERTIFICATE</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about05">PROCESS</a></li>
     <li><a href="{{ ItemMaker::url('About') }}#about07">POLICY</a></li>
      <li><a href="{{ ItemMaker::url('About') }}#about08">MANAGEMENT</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about06">GO TO KAFO</a></li>
  </ul>
 <!--董事長區-->
 ...
 <!--中間historical-->
  <section id="about03" class="about-historical" style="background: url({{ $indexData[0]['block_1_big_img'] }}) no-repeat center center; background-size: cover">
    <div class="inner">
      ...
      <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-historical" href="javascript:;">LEARN MORE</a>
    </div>
  </section>
  <!-- historical 隱藏區塊-->
  ...
  <section class="two-combine clearfix">
    <div id="about04" class="about-quality" style="background: url( {{ $indexData[0]['block_2_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-quality" href="javascript:;">LEARN MORE</a>
      </div>
    </div>
    ...
    <div id="about05" class="about-process" style="background: url( {{ $indexData[0]['block_3_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-process" href="javascript:;">LEARN MORE</a>
      </div>
    </div>
    <!---->
  </section>
    ...
    <div class="hide-process">
      ...
      <ul class="all-process clearfix">
        <li class="process-list">
          ...
          <p class="fontM">CUSTOMIZED<br>PRODUCTION LINE</p>
        </li>
        <li class="process-list">
          <i>02</i>
          <img src="/upload/about/process/icon02.png">
          <p class="fontM">UNDERSTANDING<br>NEEDS</p>
        </li>
        <li class="process-list">
          <i>03</i>
          <img src="/upload/about/process/icon03.png">
          <p class="fontM">Analysis<br>and Planning</p>
        </li>
        <li class="process-list">
          <i>04</i>
          <img src="/upload/about/process/icon04.png">
          <p class="fontM">Proposal</p>
        </li>
        <li class="process-list">
          <i>05</i>
          <img src="/upload/about/process/icon05.png">
          <p class="fontM">Order<br>and Specs Confirm</p>
        </li>
        <li class="process-list">
          <i>06</i>
          <img src="/upload/about/process/icon06.png">
          <p class="fontM">Production<br>Process</p>
        </li>
        <li class="process-list">
          <i>07</i>
          <img src="/upload/about/process/icon07.png">
          <p class="fontM">Installation<br>and Inspection</p>
        </li>
      </ul>
      <div class="about-contact">
        <p><span>If you would like to know more about our services,</span><span>PLEASE FEEL FREE TO CONTACT US.</span></p>
        <a class="hvr-rectangle-out btn-red" href="../contact/index.html">RIGHT NOW</a>
      </div>
    </div>
  </div>
  ...
  <section class="two-combine clearfix">
    <div id="about07" class="about-quality" style="background: url( {{ $indexData[0]['block_3_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-policy" href="javascript:;">LEARN MORE</a>
      </div>
    </div>
    ...
    <div id="about08" class="about-process" style="background: url( {{ $indexData[0]['block_4_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-management" href="javascript:;">LEARN MORE</a>
      </div>
    </div>
  </section>
  <!-- policy 隱藏區塊-->
  ...
  <section id="about06" class="about-plant" style="background: url( {{ $indexData[0]['block_6_big_img'] }} ) no-repeat center center; background-size: cover">
    <div class="inner">
      ...
      <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-plant" href="javascript:;">LEARN MORE</a>
    </div>
  </section>
