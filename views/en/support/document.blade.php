  ...
  <section id="document" class="document-wrap">
    <div class="container top-bar">
      <div class="bread-crumbs">
        <a href="{{ ItemMaker::url('support') }}">SUPPORT</a><span></span>
        <a href="{{ ItemMaker::url('support/file') }}">BROCHURES DOWNLOAD</a>
      </div>
    ...
    <div class="product-type">
      ...
      <a href="javascript:;"><span class="move title">SELECT CATEGORY</span></a>
