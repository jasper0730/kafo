...
<!--產品BANNER-->
  <div class="container top-bar">
    <div class="bread-crumbs">
      ...
      <a href="{{ ItemMaker::url('Product') }}">PRODUCTS</a><span></span>
...
<!---->
  ...
  <nav class="container product-d-menu">
    <ul>
      <li class="hvr-rectangle-out"><a href="{{ ItemMaker::url('Product/Series').'/'.$Series->id  }}#detail01" class="fontM">FEATURES</a></li>
      <li class="hvr-rectangle-out"><a href="{{ ItemMaker::url('Product/Series').'/'.$Series->id  }}#detail02" class="fontM">SPECIFICATION</a></li>
      @if($Series->accessory_file)
        <li class="hvr-rectangle-out"><a target="_blank" href="{{  $Series->accessory_file }}" class="fontM">MATCH TABLE</a></li>
      @endif

      @if( $Series->catelog_file )
        @if( $Series->download_directory)
          <li class="hvr-rectangle-out"><a href="{{ $Series->catelog_download }}" class="fontM" download>CATALOG DOWNLOAD</a></li>
        @else
          @if(Session()->has('Member'))
            <li class="hvr-rectangle-out"><a href="{{ $Series->catelog_download }}" class="fontM" download>CATALOG DOWNLOAD</a></li>
          @else
            <li class="hvr-rectangle-out"><a href="javascript:;" class="fontM box-btn-login" >CATALOG DOWNLOAD</a></li>
          @endif
        @endif
      @else
          <li class="no_file"><a href="javascript:;" class="no_file" >NO CATALOG</a></li>
      @endif
    </ul>
  </nav>
  ...
  <section id="detail01" class="features">
    ...
    <div id="detail02" class="features03">
      <div class="container">
        <h2 class="detail-txt-title">SPECIFICATION</h2>
    ...
    <div class="contact-us-block">
      ...
      <p class="contact-us-p">If you are interested in our products, you can contact us at any time.</p>
      <a class="contact-us-button hvr-rectangle-out" href="{{ ItemMaker::url('contact') }}">CONTACT US</a>
    </div>
