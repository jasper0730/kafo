...
<!-- 內容最上方大標題 -->
<h3 class="page-title"> 歷年財務管理
    <small>History Report</small>
</h3>
<!-- 內容最上方大標題END -->
<!--網站導覽-->
<div class="page-bar">
...
<div class="col-md-12">
    ...
    {{-- <div class="note note-danger">
        <p> 注意事項: <br>
        一頁4筆的版型(橫條)，新聞項目的列表圖尺寸為 730 x 490<br>
        一頁8筆的版型(直條)，新聞項目的列表圖尺寸為 280 x 385</p>
    </div> --}}
    <!--注意事項END-->
    <!--內容區白色區塊-->
    <div class="portlet light portlet-fit portlet-datatable ">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">歷年財務管理</span>
            </div>
            <!--actions-->
            <div class="actions">
