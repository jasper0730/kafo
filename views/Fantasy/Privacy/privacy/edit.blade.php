...
@section('title',"Privacy管理頁面管理頁面修改 "."-".$ProjectName)
@section('css')
...
<a href="" id="toFileManager"></a>
		...
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
			Privacy管理頁面 <small>News Manager</small> </h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="{{ ItemMaker::url('Fantasy/'.$routePreFix)}}">Privacy管理頁面</a> <i class="fa fa-angle-right"></i>
				</li>
				<li>
					Privacy管理頁面修改 </li>
			</ul>
                                ...
                                <div class="portlet-title portlet-title2">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">
											{{-- {{ ( !empty( $data['title'] ) )? $data['title'] : '' }} - --}} Privacy管理頁面 </span>
                                    </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active form-row-seperated" id="tab_general">
                                                <div class="form-body form_news_pad">
													...
													{{ItemMaker::idInput([
														"inputName" => "privacy[id]",
														"value" => ( !empty($data["id"]) )? $data["id"] : ""
													])}}
													{{ItemMaker::radio_btn([
														"labelText" => "是否啟用",
														"inputName" => "privacy[is_visible]",
														"helpText" =>"是否啟用",
													...
													{{ItemMaker::textInput([
														"labelText" => "排序",
														"inputName" => "privacy[rank]",
														"value" => ( !empty($data["rank"]) )? $data["rank"] : ""
													])}}
													{{ItemMaker::textarea([
														"labelText" => "標題",
														"inputName" => "privacy[title]",
														"value" => ( !empty($data["title"]) )? $data["title"] : ""
													])}}
													
													{{ItemMaker::editor([
														"labelText" => "網址",
														"inputName" => "privacy[website]",
														"value" => ( !empty($data["website"]) )? $data["website"] : ""
													])}}
													{{ItemMaker::textarea([
														"labelText" => "內容",
														"inputName" => "privacy[content]",
