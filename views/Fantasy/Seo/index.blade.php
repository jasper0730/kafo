...
<div class="col-md-12">
    ...
    <div class="note note-danger">
        <p> 注意事項: 建議全域SEO及各項單元的SEO都先填入資料。</p>
    </div>
    <!--注意事項END-->
    <!--內容區白色區塊-->
    <div class="portlet light portlet-fit portlet-datatable ">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">SEO管理</span>
            </div>
            <!--actions-->
            <div class="actions">

                <!-- <div class="btn-group btn-group-devided" >
						<a href="{{ItemMaker::url("Fantasy/SEO管理/create")}}" class="btn green-sharp btn-circle btn-sm">
