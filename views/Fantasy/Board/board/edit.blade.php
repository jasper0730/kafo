...
@section('title',"股東會頁面管理頁面管理頁面修改 "."-".$ProjectName)
@section('css')
...
<a href="" id="toFileManager"></a>
		...
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
			股東會頁面管理頁面 <small>News Manager</small> </h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="{{ ItemMaker::url('Fantasy/'.$routePreFix)}}">股東會頁面管理頁面</a> <i class="fa fa-angle-right"></i>
				</li>
				<li>
					股東會頁面管理頁面修改 </li>
			</ul>
                                ...
                                <div class="portlet-title portlet-title2">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">
											{{ ( !empty( $data['title'] ) )? $data['title'] : '' }} - 股東會頁面管理頁面 </span>
                                    </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active form-row-seperated" id="tab_general">
                                                <div class="form-body form_news_pad">
													...
													{{ItemMaker::select([
                                                        "labelText" => "所屬分類",
                                                        "inputName" => "board[category_id]",
                                                        "options"   => $parent["belong"]["boardCategory"],
                                                        "value" => ( !empty($data["category_id"]) )? $data["category_id"] : ""
                                                    ])}}
                                                    {{ItemMaker::textInput([
														"labelText" => "年份",
														"inputName" => "board[year]",
