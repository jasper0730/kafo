    ...
    <div class="portlet light portlet-fit portlet-datatable ">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">股東名單頁面</span>
            </div>
            <!--actions-->
            <div class="actions">
                ...
                <div class="btn-group btn-group-devided" >
						...
						<a href="{{ItemMaker::url("Fantasy/Board/shareholder_page/edit/1")}}" class="btn green-sharp btn-circle btn-sm">
							<i class="fa fa-plus"></i> 股東會名單頁面設定
						</a>
                </div>
