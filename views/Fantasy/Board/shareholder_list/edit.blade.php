...
<a href="" id="toFileManager"></a>
		...
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
			股東會名單頁面 <small>News Manager</small> </h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="{{ ItemMaker::url('Fantasy/'.$routePreFix)}}">股東會名單頁面</a> <i class="fa fa-angle-right"></i>
				</li>
				<li>
					股東會名單頁面修改 </li>
			</ul>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active form-row-seperated" id="tab_general">
                                                <div class="form-body form_news_pad">
													...
													{{ItemMaker::idInput([
														"inputName" => "shareholder_list[id]",
														"value" => ( !empty($data["id"]) )? $data["id"] : ""
													])}}
													{{ItemMaker::radio_btn([
														"labelText" => "是否啟用",
														"inputName" => "shareholder_list[is_visible]",
														"helpText" =>"是否啟用",
													...
													{{ItemMaker::textInput([
														"labelText" => "股東名稱",
														"inputName" => "shareholder_list[title]",
														"value" => ( !empty($data["title"]) )? $data["title"] : ""
													])}}
													{{ItemMaker::textInput([
														"labelText" => "持有股數",
														"inputName" => "shareholder_list[number]",
														"value" => ( !empty($data["number"]) )? $data["number"] : ""
													])}}
													{{ItemMaker::textInput([
														"labelText" => "持股比例",
														"inputName" => "shareholder_list[percent]",
