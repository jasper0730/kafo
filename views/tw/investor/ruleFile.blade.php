...
<div class="wrapper page-revenue">
  ...
  <section id="revenue" class="revenue-wrap">
    <a href="{{ ItemMaker::url("Policy/ruleFile") }}#revenue">
      <h2 class="move title">
    ...
    <div class="inner">
      <div class="revenue-info">
        <span>公司內規</span>
        <span>INTERNAL CONTROL PROCEDURES</span>
      </div>
      <table class="table-type1 shareholder-table regulation-table">
        <thead>
          <tr>
            <th>排序</th>
        ...
        <tbody>
          @foreach($ruleFile as $key => $value)
          <tr>
            <td class="director-num">{{ $key+1 }}</td>
