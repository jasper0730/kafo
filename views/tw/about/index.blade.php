...
<div class="wrapper page-product">
  ...
  <!-- 中間選單 -->
  <ul class="navbar">
    <li><a href="{{ ItemMaker::url('About') }}#about02">公司簡介</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about03">歷史沿革</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about04">品質認證</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about05">製程規劃</a></li>
     <li><a href="{{ ItemMaker::url('About') }}#about07">品質政策宣示文</a></li>
      <li><a href="{{ ItemMaker::url('About') }}#about08">經營團隊</a></li>
    <li><a href="{{ ItemMaker::url('About') }}#about06">營運總部</a></li>
  </ul>
 <!--董事長區-->
 ...
 <!--中間historical-->
  <section id="about03" class="about-historical" style="background: url({{ $indexData[0]['block_1_big_img'] }}) no-repeat center center; background-size: cover">
    <div class="inner">
      ...
      <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-historical" href="javascript:;">閱讀更多</a>
    </div>
  </section>
  <!-- historical 隱藏區塊-->
  ...
  <section class="two-combine clearfix">
    <div id="about04" class="about-quality" style="background: url( {{ $indexData[0]['block_2_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-quality" href="javascript:;">閱讀更多</a>
      </div>
    </div>
    ...
    <div id="about05" class="about-process" style="background: url( {{ $indexData[0]['block_3_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-process" href="javascript:;">閱讀更多</a>
      </div>
    </div>
    <!---->
  </section>
    ...
    <div class="hide-process">
      ...
      <ul class="all-process clearfix">
        <li class="process-list">
          ...
          <p class="fontM">客製化<br>專用生產線</p>
        </li>
        <li class="process-list">
          <i>02</i>
          <img src="/upload/about/process/icon02.png">
          <p class="fontM">瞭解<br>客戶需求</p>
        </li>
        <li class="process-list">
          <i>03</i>
          <img src="/upload/about/process/icon03.png">
          <p class="fontM">分析<br>及規劃</p>
        </li>
        <li class="process-list">
          <i>04</i>
          <img src="/upload/about/process/icon04.png">
          <p class="fontM">客戶端提案</p>
        </li>
        <li class="process-list">
          <i>05</i>
          <img src="/upload/about/process/icon05.png">
          <p class="fontM">訂單<br>及規格確認</p>
        </li>
        <li class="process-list">
          <i>06</i>
          <img src="/upload/about/process/icon06.png">
          <p class="fontM">生產流程</p>
        </li>
        <li class="process-list">
          <i>07</i>
          <img src="/upload/about/process/icon07.png">
          <p class="fontM">安裝驗收</p>
        </li>
      </ul>
      <div class="about-contact">
        <p><span>如果您想要了解更多關於我們的服務，</span><span>隨時歡迎與我們聯繫。</span></p>
        <a class="hvr-rectangle-out btn-red" href="../contact/index.html">立即聯繫</a>
      </div>
    </div>
  </div>
  ...
  <section class="two-combine clearfix">
    <div id="about07" class="about-quality" style="background: url( {{ $indexData[0]['block_3_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-policy" href="javascript:;">閱讀更多</a>
      </div>
    </div>
    ...
    <div id="about08" class="about-process" style="background: url( {{ $indexData[0]['block_4_big_img'] }} ) no-repeat center center; background-size: cover">
      <div class="inner">
        ...
        <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-management" href="javascript:;">閱讀更多</a>
      </div>
    </div>
  </section>
  <!-- policy 隱藏區塊-->
  ...
  <section id="about06" class="about-plant" style="background: url( {{ $indexData[0]['block_6_big_img'] }} ) no-repeat center center; background-size: cover">
    <div class="inner">
      ...
      <a class="fontM hvr-icon-wobble-vertical btn-learn jq-btn-plant" href="javascript:;">閱讀更多</a>
    </div>
  </section>
